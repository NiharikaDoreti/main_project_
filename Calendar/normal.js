...
var gBegin=[1935,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
...
var gcCalBG="#D1D1D1";	// the background color of the outer calendar panel.
var guCalBG="#D1D1D1";	//  the background image url for the inner table.
var gcCalFrame="#D1D1D1";	// the background color of the inner table, showing as a frame.
...
var gsNavPrev="<INPUT id='navPrev' type='button' value='&lt;' class='Button' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<INPUT id='navNext' type='button' value='&gt;' class='Button' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator
...
var gcSatBG="#D9F3D8";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#D9F3D8";	// Sunday background color
