...
if(f.cid.selectedIndex!=0)
{
 ...
 f.action="InsertDomainAmt.jsp?cid=" + cid + " ";
 f.submit();
}
...
try
{
 ...
 cust_rs=
 CBean.executeQuery("select cust_id from cust_req_details where cust_id not in(select cust_id from membership_fee) order by cust_id ");
%>
<table border="0" >
<tr>
